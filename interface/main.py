...
imagem_botao_0 = ImageTk.PhotoImage(Image.open("interface/assets/botao-0.png"))
imagem_botao_1 = ImageTk.PhotoImage(Image.open("interface/assets/botao-1.png"))
imagem_botao_2 = ImageTk.PhotoImage(Image.open("interface/assets/botao-2.png"))
imagem_botao_3 = ImageTk.PhotoImage(Image.open("interface/assets/botao-3.png"))
...
imagem_carta_1 = ImageTk.PhotoImage(Image.open("interface/assets/carta-1.png"))
imagem_carta_2 = ImageTk.PhotoImage(Image.open("interface/assets/carta-2.png"))
imagem_carta_3 = ImageTk.PhotoImage(Image.open("interface/assets/carta-3.png"))
...
off_1 = ImageTk.PhotoImage(Image.open("interface/assets/1-off.png"))
on_2 = ImageTk.PhotoImage(Image.open("interface/assets/2-on.png"))
...
#Configurando disse
disse_0 = ImageTk.PhotoImage(Image.open("interface/assets/disse-0.png"))
disse_2 = ImageTk.PhotoImage(Image.open("interface/assets/disse-2.png"))
disse_3 = ImageTk.PhotoImage(Image.open("interface/assets/disse-3.png"))
